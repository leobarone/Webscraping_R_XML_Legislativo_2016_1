...
Agora que sabemos substituir texto em outros textos e fazer loops, podemos mudar o número da página do nosso endereço de pesquisa.
...
No caso, usaremos "FRANGO". Lembrar que ao colocar na URL, não devemos usar as aspas mas elas se mantém ao escrever a função, pois queremos dizer que procuramos a palavra FRANGO e não o objeto FRANGO.
