...
Simples não? Geramos um endereço de URL e, após obtermos o endereço, capturamos o conteúdo da página (no caso, só as tabelas) usando o link como argumento da função readHTMLTable. Antes de avançar, vamos falar um pouco sobre listas no R (pois o resultado da função readHTMLTable é uma lista).
