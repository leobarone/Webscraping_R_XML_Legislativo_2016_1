...
Para isso, vamos usar o que o que vimos até aqui, incluindo o for loop da atividade 1, para ir de uma página a outra automaticamente.
...
O que faremos é colar nosso contador (i) no final do link. Então o que queremos é uma combinação do nosso url com o contador sem nada separando os dois. A função 'paste' funciona com os argumentos (em ordem): onde você quer colar, o que você quer colar (pode ser mais de uma coisa), especificação de qual é o separador.
...
Chegou o momento de colocar no loop tudo que queremos que execute em cada vez que ele ocorrer. Ou seja, que ele imprima na tela a página que está executando, [AQUI]que para todas elas o código HTML seja examinado, lido no R e transformado em objeto XML, colete todos os links e todos os títulos e que empilhe. Lembrando que não podemos esquecer de definir a urlbase que estamos usando
